...
1. Using the plugin is simple, just click on 'Reading' under 'Settings' in the WordPress admin and choose the page or post you want for your front page.
...
* Don't redirect when Elegant Themes Divi Visual Builder is enabled
* Tested in WordPress version 5.1.1
